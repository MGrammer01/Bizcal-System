...
export const WEBSITE_URL =
  process.env.NEXT_PUBLIC_WEBSITE_URL || "https://bizcalagency.com";
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Bizcal";
export const SUPPORT_MAIL_ADDRESS =
  process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "help@bizcalagency.com";
