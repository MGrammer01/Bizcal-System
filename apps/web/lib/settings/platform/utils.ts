...
export const platformPlans: IndividualPlatformPlan[] = [
  ...
  },
  {
    plan: "Essentials",
    description:
      "Your essential package with sophisticated support, hosted platform APIs, Bizcal Atoms (React components) and more.",
    pricing: 299,
    includes: [
...
export const helpCards: HelpCardInfo[] = [
  ...
  },
  {
    ...
    description:
      "Our Platform Starter Kit is being used in production by Bizcal itself. You can find the ready-to-rock source code on GitHub.",
    variant: "basic",
    actionButton: {
