...
export class BookingLocationController_2024_08_13 {
  ...
  @ApiOperation({
    ...
    description: `**Current Limitation:** Updating a booking location will update the location in Bizcal, but the corresponding Calendar event will not be updated automatically. The old location will persist in the Calendar event. This is a known limitation that will be addressed in a future update.
